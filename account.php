...
<body>
	...
	<section class="">
		...
		?>
			...
			<section class="caption">
				...
				<h3 class="properties" style="text-align: center">Range Rovers - Toyota Ist - Landcruisers</h3>
			</section>
	...
	<section class="search">
		...
		<div id="fom">
			<form method="post">
			<h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Client Credentials Area</h3>
				<table height="100" align="center">
					...
					<tr>
						...
						<td style="text-align:right;"><a href="signup.php">REGISTER HERE</a></td>
					</tr>
				</table>
			</form>
			<?php
